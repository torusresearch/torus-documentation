...
Latest update: 09 December 2019

---

This cookie policy is only applicable to Torus website  not
. The Torus wallet does not use any cookies.
...
traffic through , i.e., communication between Torus Labs and the
User's browser, while also allowing analytical data from  to be
collected.
...
example – third parties from installing Cookies. Through browser preferences, it
is also possible to delete Cookies installed in the past, including the Cookies
that may have saved the initial consent for the installation of Cookies by this
website. Users can, for example, find information about how to manage Cookies in
...
Torus Labs Private Limited 60 Paya Lebar Road, \#04-46, Paya Lebar Square,
Singapore 409051
