...
[Integrate Torus](getting-started) into your DApp with just a few lines of code
and give your users an amazing onboarding experience:
...
![Architecture](../static/assets/graph-6-final.png)
...
[system architecture](how-torus-works/system-architecture) or our
