...
For DApp integrations, refer the [Get Started](../get-started) section. To use
the wallet, head over to [app.tor.us](https://app.tor.us)
...
whitelist process, please reach out at hello@tor.us.
...
[https://t.me/web3auth](https://t.me/web3auth).
