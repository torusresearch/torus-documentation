...
Instantiate the SDK by creating an instance of `TorusSwiftDirectSDK` with login
configurations of your choice then trigger user login when it's appropriate in
your application:
